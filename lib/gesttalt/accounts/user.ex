defmodule Gesttalt.Accounts.User do
  ...
  def registration_changeset(user, attrs, opts \\ []) do
    ...
    |> maybe_generate_handle_from_email()
  ...
  defp maybe_generate_handle_from_email(changeset) do
    if get_change(changeset, :handle) do
      ...
      case get_change(changeset, :email) do
        ...
        email ->
          ...
          put_change(changeset, :handle, base_handle)
      end
    end
  end
  ...
  def validate_handle(changeset, opts \\ []) do
    ...
    |> validate_format(:handle, ~r/^[a-z0-9]+$/, message: "must contain only lowercase letters and numbers")
  ...
  defp maybe_validate_unique_handle(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:handle, Gesttalt.Repo)
